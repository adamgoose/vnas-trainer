...
export const COMMAND_REFERENCE = `PUSH [taxiway] | TAXI <taxiways...> [CROSS <rwy...>] [HS <pt>] | RWY <runway> TAXI <taxiways...> [CROSS <rwy...>] [HS <pt>] |
HS <pt> | CROSS [rwy] | RES | HOLD | BREAK | GIVEWAY <callsign> | LUAW | CTO [L|R] [hdg] | EXIT |
